...
python core_elmo_weighted_avg.py ../nlpcc-iccpol-2016.kbqa.testing-data answer_elmo_weighted_avg_hinge ../full_dataset/kbJson.cleanPre.alias.utf8 ../full_dataset/outputAP ../full_dataset/countChar ../full_dataset/vectorJson.utf8 1 30 loss-hinge-epochs-10-margin-0.5/elmo_sim_model-epoch9.pth
